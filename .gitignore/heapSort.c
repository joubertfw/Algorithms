/*HeapSort: V[0...m]
    -O indice 0 � a raiz da �rvore
    -O pai de qualquer �ndice f � f/2 (piso)
    -O filho esq de um �ndice p � 2p + 1 (ele s� existe se 2p + 1 <= m)
    -O filho dir de um �ndice p � 2p + 2 (ele s� existe se 2p + 2 <= m)
    -O valor de todo pai � maior ou igual que seus dois filhos: V[f/2] >= V[f]
*/
